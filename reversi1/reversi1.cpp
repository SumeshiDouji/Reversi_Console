...
int main()
{
    ...
    while (1)
    {
        ...
        while (1)
        {
            ...
            {
                cout << "Umm,This position is not exist." << endl
                     << endl;
                continue;
            }
            if (board[col - 1][row - 1] != '#')
            {
                cout << "Nooo!!This position is already placed." << endl
                     << endl;
                continue;
            }
            // 置き換え
            if (ReplaceBoard(col, row, 'x') == 0)
            {
                cout << "Waoh,This position cannot replace other koma." << endl
                     << endl;
                continue;
            }
            break;
